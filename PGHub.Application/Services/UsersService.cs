...
public class UsersService : IUsersService
{
    ...
    public async Task<UserDTO> GetByIdAsync(Guid id)
    {
        ...
        catch (Exception ex)
        {
            ...
            throw new Exception("An error occurred while retrieving the user with the ID: {UserId}" + id + ".", ex);
        }
    ...
    public async Task<UserDTO> CreateAsync(CreateUserDTO createUserDTO)
    {
        ...
        catch (Exception ex)
        {
            ...
            throw new Exception("An error occurred while creating a user with email {UserEmail}." + createUserDTO.Email, ex);
        }
    ...
    public async Task<UserDTO> UpdateAsync(Guid id, UpdateUserDTO updateUserDTO)
    {
        ...
        try
        {
            ...
            if (updatedUser == null)
            {
                // Handle the case where the update operation did not return a user
                throw new Exception("An error occurred while updating the user. The user could not be found.");
            }
        ...
        catch (Exception ex)
        {
            ...
            throw new Exception("An error occurred while updating a user with ID {UserId}." + id, ex);
        }
    }
    ...
    public async Task<bool> DeleteAsync(Guid id)
    {
        ...
        catch (Exception ex)
        {
            ...
            throw new Exception("An error occurred while deleting the user with ID {UserId}." + id, ex);
        }
    }
}
